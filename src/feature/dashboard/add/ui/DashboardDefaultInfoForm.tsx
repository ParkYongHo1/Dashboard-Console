import { DashBoardDefaultInfoForm, DashBoardInfoProps, DashBoardDefaultInfoForm as FormType } from "@/types/dashboard-info";
import { FieldErrors, UseFormRegister, UseFormSetValue, UseFormWatch, UseFormTrigger } from "react-hook-form";
...
const DashboardDefaultInfoForm = ({ register, errors, onSubmit, tableNamesList, setValue, watch, trigger }: Props) => {
  ...
  return (
    <form onSubmit={onSubmit}>
      <DashboardDefaultFormField mode="add" register={register} tableNamesList={tableNamesList} selectedDatabase={selectedDatabase} onDatabaseChange={handleDatabaseChange} />
