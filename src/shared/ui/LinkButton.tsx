...
export const LinkButton = ({
  ...
  const typeStyles = {
    ...
    button: "px-4 py-1.5 bg-blue-500 text-white rounded-[5px] hover:bg-blue-600 hover:cursor-pointer transition-colors ",
  ...
  const linkClasses = `
    ${typeStyles[type]}
    ${isActive ? "text-black font-bold" : "font-medium text-gray-400"}
  `;
